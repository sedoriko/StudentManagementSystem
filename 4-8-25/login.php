...
<body>
    <div class="container">
        ...
        <a href="landing_page.php">
            <img src="background/logo.jpg" alt="University Logo" style="width: 150px; height: auto; position: absolute; top: 70px; left: 50%; transform: translateX(-50%); cursor: pointer;">
        </a>
        <div class="university-title">
            Philippine University of the Philippines
        </div>
